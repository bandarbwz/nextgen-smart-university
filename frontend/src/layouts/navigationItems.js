...
export const navigationGroups = [
    {
        ...
        items: [
            ...
            { to: '/settings', label: 'Settings', icon: SlidersHorizontal, roles: null },
        ],
    },
    {
        label: 'Academic',
        items: [
            ...
            {
                to: '/exam-resets',
                label: 'Examination Resets',
                icon: RotateCcw,
                roles: ['Student', 'Lecturer', 'Coordinator'],
            },
    ...
    },
    {
        ...
        items: [
            ...
            { to: '/system', label: 'System', icon: Server, roles: ['Administrator'] },
