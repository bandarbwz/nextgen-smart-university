...
class TestDatabase
{
    private const SCHEMA_FILES = [
        ...
        '15-exam-reset.sql',
        '16-role-management.sql',
        '17-settings-system.sql',
    ];
    ...
    {
        $tables = [
            'SystemLog', 'UserSetting',
            'AuthorizationLog',
            'ExamResetLog', 'ExamResetRequest',
            ...
            'Event', 'Club',
            'AIReport', 'ExamRecording', 'BrowserActivity', 'HeadPose', 'EyeTracking',
            'FaceDetection', 'AIViolation', 'ExamSubmission', 'ExamSession',
            'ExamQuestion', 'Exam',
